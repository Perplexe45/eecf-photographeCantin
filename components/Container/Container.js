        ...
        <nav className="navbar navbar-expand-lg navbar-dark justify-content-center fixed-top">
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex mx-3">
              ...
              <div className={`navbar-collapse ${collapsed ? "collapse" : "show"}`}  >
                <div className="d-flex">
                  <Link href="/" className="navbar-brand text-center custom-link">
                    Accueil
                  </Link>
                  <Link href="/galerie" className="navbar-brand text-center custom-link">
                    Galerie
                  </Link>
                  <Link href="/tarif" className="navbar-brand activetext-center custom-link">
                    Tarifs
                  </Link>
                  <Link href="/contact" className="navbar-brand custom-link">
                    Contact
                  </Link>
                  <Link href="http://localhost:1337/admin" className="navbar-brand custom-link">
                    Connexion
                  </Link>
